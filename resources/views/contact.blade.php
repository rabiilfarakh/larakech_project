...
<body class="bg-gray-200">
    <div class="rounded-lg overflow-hidden mx-4 md:mx-10 mt-5">
        ...
        <div class="flex justify-between items-center">
            <form action="/search" class="max-w-96 mt-5">
                <div class="relative">
                    <input type="text" name="" class="w-96 border h-12 shadow p-4 rounded-lg dark:text-gray-800 dark:border-gray-700 dark:bg-gray-200" placeholder="Recherche...">
                </div>
            </form>
            <button data-modal-toggle="crud-modal" data-modal-target="crud-modal" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                + Ajouter
            </button>
        </div>
